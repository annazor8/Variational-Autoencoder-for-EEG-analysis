...
for idx_ch, ch in enumerate(new_channel_names):
    ...
    output_path = Path('/home/azorzetto/train{}/img_min_error/{}.png'.format(train_session, ch))
    plt.savefig(output_path)
    mpld3.save_html(plt.gcf(), "//home/azorzetto/train{}/img_min_error/{}.html".format(train_session, ch))
    plt.close()
...
for idx_ch, ch in enumerate(new_channel_names):
    ...
    output_path = Path('/home/azorzetto/train{}/img_max_error/{}.png'.format(train_session, ch))
    plt.savefig(output_path)
    mpld3.save_html(plt.gcf(), "//home/azorzetto/train{}/img_max_error/{}.html".format(train_session, ch))
...
x_eeg_random=test_data[50]
x_r_eeg_random=x_r_eeg[50]
...
for idx_ch, ch in enumerate(new_channel_names):
    ...
    output_path = Path('/home/azorzetto/train{}/random_trial/{}.png'.format(train_session, ch))
    plt.savefig(output_path)
    mpld3.save_html(plt.gcf(), "//home/azorzetto/train{}/random_trial/{}.html".format(train_session, ch))

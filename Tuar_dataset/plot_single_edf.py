...
channels_to_set_MONOPOLAR=['EEG FP1-REF', 'EEG FP2-REF', 'EEG F3-REF', 'EEG F4-REF', 'EEG C3-REF', 'EEG C4-REF',
                       ...
                       'EEG T1-REF', 'EEG T2-REF']
raw_mne = mne.io.read_raw_edf("/home/azorzetto/dataset/01_tcp_ar/aaaaabsk_s007_t000.edf",
...
raw_mne.pick_channels(channels_to_set_MONOPOLAR,
...
for i in range(76, epoch_data.shape[0]):
    for idx_ch, ch in enumerate(channels_to_set_MONOPOLAR):
            ...
            # Adjust layout
            plt.tight_layout()
            output_dir = Path(f'/home/azorzetto/aaaaabsk_s007_t000_A1_reference')
